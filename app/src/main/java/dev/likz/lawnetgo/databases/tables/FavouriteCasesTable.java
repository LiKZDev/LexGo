...
public class FavouriteCasesTable {
  public static final String TABLE_FAVOURITE_CASE = "favourite_case_table";
  ...
  public static void onCreate(SQLiteDatabase database) {
    Log.d(DAOManager.LOG_TAG, "Creating db");
  ...
  public static void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
    ...
    db.execSQL("DROP TABLE IF EXISTS " + TABLE_FAVOURITE_CASE);
    onCreate(db);
  }
